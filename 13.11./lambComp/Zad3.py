...
parni_kvadrati = [i ** 2 for i in range(20, 51)] 
...
kubovi = [{i: i ** 3} if i % 2 != 0 else {i: i} for i in range(1, 11)] 
...
korijeni = {i: round(i**(1/2), 2) for i in range(50, 501, 50)} 
...
zbrojeni_bodovi = [{student["prezime"]: reduce(lambda x, y: x + y, student["bodovi"])} for student in studenti] 
